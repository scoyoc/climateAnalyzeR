...
Now let's use the `annual_figure()` function to plot annual precipitation (PRCP), maximum temperature (TMAX), and minimum temperature (TMIN) data along with the 1981-2010 normals.
...
monthly_figure(x_var = isky_monthly$water_mth, y_var = isky_monthly$prcp,
                year_group = isky_monthly$water_yr, 
                y_intercept = ann_prcp_normals$value, my_year = 2025,
                line_color = "green4",
