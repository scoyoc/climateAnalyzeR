...
annual_figure(x_var = isky_annual$year, y_var = isky_annual$tmax_cy,
              ...
              my_title = my_title, my_ylab = "Temperature (deg F)")
```
...
```{r monthly_figures, message=FALSE, warning=FALSE, fig.width=7, fig.height=15}
# Monthly TMAX figure
mth_tmax <- monthly_figure(x_var = isky_monthly$water_mth, 
                           y_var = isky_monthly$tmax,
                           year_group = isky_monthly$water_yr, my_year = 2025,
                           line_color = "red3",
                           my_title = "Monthly Maximum Temperature (1965-2025)",
                           my_ylab = "Temp (°F)")
# Monthly TMIN figure
mth_tmin <- monthly_figure(x_var = isky_monthly$water_mth, 
                           y_var = isky_monthly$tmin,
                           year_group = isky_monthly$water_yr, my_year = 2025,
                           line_color = "blue",
                           my_title = "Monthly Minimum Temperature (1965-2025)",
                           my_ylab = "Temp (°F)")

# Monthly precipitation figure
mth_prcp <- monthly_figure(x_var = isky_monthly$water_mth, 
                           y_var = isky_monthly$prcp,
                           year_group = isky_monthly$water_yr, my_year = 2025,
                           line_color = "green4",
                           my_title = "Monthly Precipitation (1965-2025)",
                           my_ylab = "Precip (inches)")

cowplot::plot_grid(mth_tmax, mth_tmin, mth_prcp, labels = c(), 
                   ncol = 1, align = "v", vjust = 1, scale = 1)
```
